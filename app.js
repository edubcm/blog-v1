...
app.get('/posts/:id', (req, res) => {
  ...
  validateParam = posts.some((data) => data.title.toLowerCase().replace(' ', '-') == id.toLowerCase().replace(' ', '-'));

  if(validateParam){
    function getIndex(element){
      return element.title.toLowerCase().replace(' ', '-') == id.toLowerCase().replace(' ', '-');
    }
    let postIndex = posts.findIndex(getIndex);
    res.render('post.ejs', {
